        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="relative h-full bg-gradient-to-b from-[#ff4400] to-[#cc3600] rounded-[35px] p-8 border border-white/10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 flex flex-col overflow-hidden">
      ...
      <Container>
        ...
        <div className="text-center mt-12 md:mt-20">
          <div className="relative inline-block group isolate">
            ...
            {/* Tooltip */}
            <div
              className="hidden lg:block absolute -top-32 left-1/2 -translate-x-1/2 md:-top-14 md:translate-y-0 md:left-full md:ml-32 opacity-100 transition-opacity duration-500 scale-90 md:scale-100 pointer-events-none w-max"
