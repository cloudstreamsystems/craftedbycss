  ...
  return (
    ...
    >
      ...
      {(writing && !isDone) ? (
        ...
        /* 
         * SECURITY NOTE: We are using dangerouslySetInnerHTML here to render the 
         * syntax-highlighted HTML generated by Shiki. Shiki is a trusted library 
         * that escapes HTML content by default. However, if the `code` prop 
         * were to come from untrusted user input, this could be an XSS vector.
         * Ensure that `code` is always sourced from trusted static content.
         */
