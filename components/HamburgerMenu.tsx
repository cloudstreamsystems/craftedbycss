                    ...
                    <div className="flex flex-col space-y-6 max-w-4xl mx-auto w-full">
                        {navigation.map((item, index) => (
                            ...
                            >
                                <Link
                                    href={item.href}
                                    className="flex items-center justify-between text-4xl md:text-6xl font-bold text-white hover:text-[#ff4500] transition-colors group"
                                    onClick={() => setMenuOpen(false)}
                                >
                                    {item.name}
                                    <ArrowRight className="opacity-0 -translate-x-8 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-[#ff4500] w-8 h-8 md:w-12 md:h-12" />
                                </Link>
                        ...
                        >
                            <Link href="/contact" onClick={() => setMenuOpen(false)}>
                                <button className="w-full md:w-auto bg-[#ff4500] text-[#1e1b4b] py-4 px-12 rounded-full font-bold text-xl hover:bg-white transition-colors duration-300 shadow-lg shadow-[#ff4500]/20">
                                    Start Your Project
                                </button>
                            </Link>
                        </motion.div>
