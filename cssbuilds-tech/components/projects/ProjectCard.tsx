  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <h3 className="text-2xl font-bold mb-2 text-[#4B3A5E] group-hover:text-[#7076C6] transition-colors">
          {project.title}
        </h3>
        ...
        <div className="flex flex-wrap gap-2">
          {project.tags.map((tag, index) => (
            <span
              key={index}
              className="text-xs text-gray-600 bg-gray-50 border border-gray-200 px-3 py-1 rounded-full hover:border-[#7076C6] hover:text-[#7076C6] transition-colors"
            >
              {tag}
            </span>
          ))}
