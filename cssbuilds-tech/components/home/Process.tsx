...
export default function Process() {
  ...
  return (
    <section ref={sectionRef} className="py-32 bg-gradient-to-b from-indigo-50 to-white relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-1/2 left-0 w-72 h-72 bg-indigo-200/30 rounded-full blur-3xl" />
      ...
      <Container>
        ...
        <div className="relative">
          {/* Connection line */}
          <div ref={lineRef} className="hidden lg:block absolute top-12 left-0 right-0 h-1 bg-gradient-to-r from-indigo-200 via-cyan-200 to-indigo-200 origin-left" style={{ top: '4rem' }} />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
            {processSteps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-3xl p-8 h-full shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-[#3730a3]/20">
                    {/* Step Number with Icon */}
                    <div className="relative mb-6">
                      <div className="w-20 h-20 bg-gradient-to-br from-[#3730a3] via-[#06B6D4] to-[#3730a3] rounded-2xl flex items-center justify-center shadow-xl">
                        <Icon className="w-10 h-10 text-white" />
                      </div>
                      <div className="absolute -top-2 -right-2 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md border-2 border-[#3730a3]">
