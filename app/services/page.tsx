            ...
            <div className="grid gap-8 md:gap-12">
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    {/* Icon/Visual Side */}
                    <div className={`w-full md:w-1/3 relative z-20 ${service.id === "cybersecurity" ? "md:-ml-16" : ""}`}>
                      {service.id === "brand-identities" ? (
                        ...
                        <div className="relative w-full aspect-square md:aspect-auto md:h-[500px] md:mr-12 rounded-[32px] overflow-hidden p-4 md:p-0">
                          <RotatingImage
                    ...
                    {service.id === "web-design" ? (
                      ...
                      <div className="w-full md:w-2/3 relative md:pl-32">
                        {/* Background Shape */}
